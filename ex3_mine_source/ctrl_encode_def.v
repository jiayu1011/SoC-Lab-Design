...
`define Instruction_Fetch          5'b00001
`define Instruction_Decode         5'b00010
`define Jump_Completion            5'b00011
`define Execution                5'b00100
`define Memory_Address_Computation 5'b00101
`define Branch_Completion        5'b00110 
`define Memory_Access_Load         5'b00111
`define Memory_Access_Store        5'b01000
`define MemRead_Completion         5'b01001
`define Rtype_Completion         5'b01010
...
`define OP_bgez_bltz  6'b000001//閲嶅
